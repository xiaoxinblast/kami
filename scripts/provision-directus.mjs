...
async function ensureServiceAccount() {
  ...
  const permissionPlan = [
    ...["create", "read", "update", "delete"].map((action) => ["localization_projects", action]),
    ...["create", "read", "update", "delete"].map((action) => ["project_resource_libraries", action]),
    ...Object.values(localeCollections).flatMap(({ key }) => ["create", "read", "update", "delete"].map((action) => [key, action])),
    ...Object.values(memoryCollections).flatMap(({ key }) => ["create", "read", "update", "delete"].map((action) => [key, action])),
    ...["create", "read", "delete"].map((action) => ["corpus_documents", action]),
    ...["create", "read", "update", "delete"].map((action) => ["term_candidates", action]),
    ...["create", "read", "update", "delete"].map((action) => ["term_import_batches", action]),
    ...["create", "read", "update", "delete"].map((action) => ["batch_runs", action]),
    ...["create", "read", "update", "delete"].map((action) => ["style_profiles", action]),
    ...["create", "read", "update", "delete"].map((action) => ["user_profiles", action]),
    ...["create", "read", "update", "delete"].map((action) => ["style_evidence", action]),
    ...["create", "read", "update", "delete"].map((action) => ["style_learning_runs", action]),
    ...["create", "read", "update", "delete"].map((action) => ["learning_trajectories", action]),
